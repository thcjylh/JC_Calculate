...
expect_strength =19.6#MPa
#expect_strength -=random.randint(4,6)# MPa
#aver_strength = f.xy(expect_strength * random.randint(100, 105) / 100, 0.1)
aver_strength = f.xy(expect_strength, 0.1)
force = []
strength = []
aver = 0
...
while aver != aver_strength:
    ...
    strength = []
    for i in range(3):
        temp = f.xy(expect_strength *22.5 * random.randint(93, 107) / 100, 0.5)
        force.append(temp)
